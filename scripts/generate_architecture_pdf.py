...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Data Tables - Clean Standard Borders, No Badge Backgrounds */
    table.data-table {
      width: 100%;
...
<body>
  ...
  <table class="data-table">
    ...
    <tbody>
      <tr>
        ...
        <td class="text-center"><strong>Akses Penuh</strong></td>
        <td class="text-center">Tiket Ditugaskan</td>
        <td class="text-center">Ditolak</td>
      </tr>
      <tr>
        <td>Penerbitan Tiket Baru & Pengisian Data Awal</td>
        <td class="text-center"><strong>Akses Penuh</strong></td>
        <td class="text-center">Input Lapangan</td>
        <td class="text-center">Ditolak</td>
      </tr>
      <tr>
        <td>Penugasan & Pergantian Teknisi Penanggung Jawab</td>
        <td class="text-center"><strong>Kontrol Penuh</strong></td>
        <td class="text-center">Hanya Baca</td>
        <td class="text-center">Ditolak</td>
      </tr>
      <tr>
        <td>Penyalinan Tautan Pelacakan Klien (Token URL)</td>
        <td class="text-center"><strong>Akses Khusus</strong></td>
        <td class="text-center">Disembunyikan</td>
        <td class="text-center">Ditolak</td>
      </tr>
      <tr>
        <td>Pratinjau & Pengiriman Surel Notifikasi Manual</td>
        <td class="text-center"><strong>Akses Khusus</strong></td>
        <td class="text-center">Disembunyikan</td>
        <td class="text-center">Ditolak</td>
      </tr>
      <tr>
        ...
        <td class="text-center">Bisa Menambah</td>
        <td class="text-center"><strong>Pelaksana Utama</strong></td>
        <td class="text-center">Ditolak</td>
      </tr>
      <tr>
        <td>Pengajuan & Pencabutan Jeda SLA (Pause)</td>
        <td class="text-center">Validasi Otoritas</td>
        <td class="text-center"><strong>Pelaksana Utama</strong></td>
        <td class="text-center">Ditolak</td>
      </tr>
      <tr>
        <td>Penyelesaian Tiket & Analisis Akar Masalah (RCA)</td>
        <td class="text-center">Verifikasi Akhir</td>
        <td class="text-center"><strong>Pelaksana Utama</strong></td>
        <td class="text-center">Ditolak</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="text-center"><strong>Persetujuan SOP</strong></td>
        <td class="text-center">Ajukan & Membaca</td>
        <td class="text-center">Hanya Baca</td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="svg-diagram-card">
    <svg viewBox="0 0 680 230" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M120 41 L145 41" stroke="#475569" stroke-width="1.5"/>
